...
void C_ConfigManager::setup()
{
	...
	setup_item(&g_cfg.misc.auto_accept, false, crypt_str("Misc.auto_accept_matchmaking"));
	...
	setup_item(&g_cfg.movement.recordBool, false, crypt_str("Movement.recording"));
	...
	setup_item(&g_cfg.menu.menu_theme, Color(138, 8, 184), crypt_str("Menu.menu_color"));
