...
# prefer a `modules.qwerty' file in OBJ_DIR over TOP_DIR.
#
ifndef MODULES_CFG
  MODULES_CFG := $(TOP_DIR)/modules.qwerty
  ifneq ($(wildcard $(OBJ_DIR)/modules.qwerty),)
    MODULES_CFG := $(OBJ_DIR)/modules.qwerty
  endif
endif
