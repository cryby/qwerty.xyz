...
public:
	...
	virtual void             SetDecrypt_stroyedOnRecreateEntities(void) = 0;
};
...
crypt_struct studiohdr_t;
crypt_struct mstudiohitboxset_t;
crypt_struct mstudiobbox_t
{
	int     bone;                 // 0x0000
	int     group;                // 0x0004
	Vector  bbmin;                 // 0x0008
...
enum animstate_layer_t
{
	...
	ANIMATION_LAYER_MOVEMENT_crypt_strAFECHANGE,
...
enum animstate_pose_param_idx_t
{
	...
	PLAYER_POSE_PARAM_crypt_strAFE_DIR,
	...
	//PLAYER_POSE_PARAM_crypt_strAFE_CROSS,
	PLAYER_POSE_PARAM_COUNT,
};

crypt_struct animstate_pose_param_cache_t
{
	bool		m_initialized;
	int			m_index;
	const char* m_name;
...
CCSGOPlayerAnimState(C_BasePlayer* m_player);*/
	...
	float					m_crypt_strafe_change_weight_smooth_fall_off = 0.0f;
	...
	float					m_crypt_strafe_change_weight = 0.0f;
	float					m_crypt_strafe_change_target_weight = 0.0f;
	float					m_crypt_strafe_change_cycle = 0.0f;
	int						m_crypt_strafe_sequence = 0;
	bool					m_crypt_strafe_changing = false;
	float					m_duration_crypt_strafing = 0.0f;
...
enum
{
	...
	EFL_DIRTY_ABcrypt_strANSFORM = (1 << 11),
...
public:
	...
	int CBaseVPhysiccrypt_strigger = -1;
...
#include "../utils/crypt_str.h"
	...
	std::string GetGunName()
	{
		...
		case WEAPON_FAMAS:
			...
			break;
		case WEAPON_FIVESEVEN:
			return crypt_str("FiveSeven");
			break;
		case WEAPON_FLASHBANG:
			return crypt_str("Flash");
			break;
		case WEAPON_G3SG1:
...
public:
	...
	std::string* m_data;   // 0x10 std::crypt_string
...
public:
	...
	virtual const char* Tocrypt_string() const = 0;
};
