...
void otheresp::indicators()
{
	...
	render::get().rect_filled(25, 428, 200, 25, Color(0, 10, 20, 150));

	render::get().text(fonts[KEYBIND1], 35, 432, Color(0, 130, 255), true, "a");
...

	{
		...
		render::get().text(fonts[KEYBIND], 35, 432 + 12 + 13 * offset, Color(255, 255, 255), true, "Double Tap");

		render::get().text(fonts[KEYBIND], 200, 432 + 12 + 13 * offset, Color(255, 255, 255), true, "on");
...

	{
		...
		render::get().text(fonts[KEYBIND], 35, 432 + 12 + 13 * offset, Color(255, 255, 255), true, "Hide Shots");
...

	{
		...
		render::get().text(fonts[KEYBIND], 35, 432 + 12 + 13 * offset, Color(255, 255, 255), true, "Safe Points");
...

	{
		...
		render::get().text(fonts[KEYBIND], 35, 432 + 12 + 13 * offset, Color(255, 255, 255), true, "Body Aim");
	...
	if (key_binds::get().get_key_bind_state(4 + g_ctx.globals.current_weapon) && !weapon->is_non_aim() && g_ctx.globals.current_weapon != -1)

	{

		render::get().text(fonts[KEYBIND], 35, 432 + 12 + 13 * offset, Color(255, 255, 255), true, "Damage override");
